package io.javaboot.starter.thirdparty.mail;
 ...
 */
@SpringBootTest(classes = JavaBootThirdPartyMailApplicationTests.class)
@ComponentScan("io.javaboot")
@Slf4j
class JavaBootThirdPartyMailApplicationTests {
